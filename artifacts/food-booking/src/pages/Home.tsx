              ...
              <div className="bg-card border border-border rounded-xl p-8 text-center shadow-lg animate-in fade-in zoom-in duration-500 space-y-5">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground font-sans">
                    Thank you! Your order has been received. We will confirm it shortly via WhatsApp.
                  </p>
                </div>

                {/* PhonePe Payment */}
                <div className="border border-border rounded-xl p-5 bg-accent/30 space-y-3">
                  <p className="text-sm font-semibold text-foreground">Pay via PhonePe to confirm your order</p>
                  <img
                    src="/phonepe-qr.png"
                    alt="PhonePe QR code – AMEED HUSSAIN SHAIK"
                    className="w-48 h-auto mx-auto rounded-lg"
                  />
                  <p className="text-xs text-muted-foreground">Scan with any UPI app · AMEED HUSSAIN SHAIK</p>
                  <p className="text-xs text-orange-600 font-medium">Payment confirms your order. Send screenshot on WhatsApp.</p>
                </div>

                {whatsappNumber && (
                  <a
                    href={whatsAppLink(whatsappNumber, "Hi! I just placed an order at Home Kitchen. Here is my payment screenshot:")}
                    target="_blank"
                    rel="noopener noreferrer"
